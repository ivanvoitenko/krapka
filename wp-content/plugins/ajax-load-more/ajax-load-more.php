...
add_filter('site_transient_update_plugins', function ($value) {
    ...
    if (is_object($value) && isset($value->response[plugin_basename(__FILE__)]))
...
define('ALM_VERSION', '3.1.2');
define('ALM_RELEASE', 'July 11, 2017');
...
;
                    ...
                    if ($data) {
                        $data .= apply_filters('alm_append_data', $repeater);
                    }
