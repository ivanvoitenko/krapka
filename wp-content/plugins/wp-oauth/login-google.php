...
function get_oauth_identity($wpoa) {
    ...
    if(isset($result_obj['displayName']))
        $_SESSION["WPOA"]["USERNAME"] = $result_obj['displayName'];


    if(isset($result_obj['emails'][0]['value']))
        $_SESSION["WPOA"]["EMAIL"] = $result_obj['emails'][0]['value'];
